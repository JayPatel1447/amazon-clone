        ...
        <div className="home">
            <div className="home__container">
                ...
                <div className="home__row">
                    ...
                    <Product id="456" title="Acer Nitro 5 Gaming Laptop, 10th Gen Intel Core i5-10300H, NVIDIA GeForce GTX 1650 Ti, 15.6 "
                       price={699.99} image="https://th.bing.com/th/id/OIP.5EZRHGR0LgL2IWcQ511TkQHaF5?w=240&h=191&c=7&o=5&pid=1.7" rating={5}/>

                    
                </div>
                <div className="home__row">
                <Product title="SAMSUNG LC34J791WTNXZA 34-Inch CJ791 Ultrawide Curved Gaming Monitor, White" price={649.99} image="https://th.bing.com/th/id/OIP.rRRS_NvNJXUO4-yTU3SqpQHaEK?pid=Api&rs=1" rating={4}/>
                <Product title="Laura Ashley Home Charlotte Collection Luxury Ultra Soft Comforter, All Season Premium Bedding Set," price={149.99} image="https://media.istockphoto.com/photos/brown-wooden-bed-isolated-on-white-background-picture-id91714601?k=6&m=91714601&s=612x612&w=0&h=ZF_iuOY8BHVPHF_-wWnNItAkfFqbNrMhSDHXpsuRd1g=" rating={4}/>
                <Product title="The lean startupThe Lean Startup: How Today's Entrepreneurs Use Continuous Innovation to Create Radically Successful Businesses" price={29.99} image="https://i.ebayimg.com/images/g/-OQAAOSwpsJf0nns/s-l640.jpg" rating={4}/>
